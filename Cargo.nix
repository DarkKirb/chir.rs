...
if !lockHashIgnored && (nixifiedLockHash != currentLockHash) then
  ...
  in
  {
      ...
      overridableMkRustCrate
        (profileName: rec {
          ...
          dependencies = {
            ...
            aws_sdk_ssooidc =
              (rustPackages."registry+https://github.com/rust-lang/crates.io-index".aws-sdk-ssooidc."1.57.0" {
                inherit profileName;
              }).out;
            aws_sdk_sts =
    ...
    "registry+https://github.com/rust-lang/crates.io-index".aws-sdk-ssooidc."1.57.0" =
      overridableMkRustCrate
        (profileName: rec {
          ...
          src = fetchCratesIo {
            inherit name version;
            sha256 = "aba487b6a05de9858f83c05133ddd1b465be60b95460491f96c5c7b761823a04";
          };
          dependencies = {
            aws_credential_types =
              (rustPackages."registry+https://github.com/rust-lang/crates.io-index".aws-credential-types."1.2.1" {
