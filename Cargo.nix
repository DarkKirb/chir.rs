...
if !lockHashIgnored && (nixifiedLockHash != currentLockHash) then
  ...
  in
  {
    ...
    "registry+https://github.com/rust-lang/crates.io-index".aws-sdk-s3."1.81.0" =
      overridableMkRustCrate
        (profileName: rec {
          name = "aws-sdk-s3";
          version = "1.81.0";
          ...
          src = fetchCratesIo {
            inherit name version;
            sha256 = "fb2ea66273123dbffd673dc7a2a04184cdd0c77f81d5c919bd6a4f4733a75094";
          };
          features = builtins.concatLists [
            [ "default" ]
            [ "default-https-client" ]
    ...
    "unknown".chir-rs-castore."0.1.0" = overridableMkRustCrate (profileName: rec {
      ...
      dependencies = {
        ...
        aws_sdk_s3 =
          (rustPackages."registry+https://github.com/rust-lang/crates.io-index".aws-sdk-s3."1.81.0" {
            inherit profileName;
          }).out;
        blake3 =
