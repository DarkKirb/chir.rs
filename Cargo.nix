...
let
  nixifiedLockHash = "ec5dbb43dab153c0ca354248a8c16b9de6d1155f120fa2994ba316eb218f0c21";
...
in
{
  ...
  "registry+https://github.com/rust-lang/crates.io-index".aws-config."1.5.10" = overridableMkRustCrate (profileName: rec {
    name = "aws-config";
    version = "1.5.10";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "9b49afaa341e8dd8577e1a2200468f98956d6eda50bcf4a53246cc00174ba924"; };
    features = builtins.concatLists [
    ...
    dependencies = {
      ...
      aws_runtime = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".aws-runtime."1.4.4" { inherit profileName; }).out;
      aws_sdk_sso = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".aws-sdk-sso."1.50.0" { inherit profileName; }).out;
      aws_sdk_ssooidc = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".aws-sdk-ssooidc."1.51.0" { inherit profileName; }).out;
      aws_sdk_sts = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".aws-sdk-sts."1.51.0" { inherit profileName; }).out;
      ...
      aws_smithy_runtime = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".aws-smithy-runtime."1.7.4" { inherit profileName; }).out;
      ...
      aws_smithy_types = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".aws-smithy-types."1.2.9" { inherit profileName; }).out;
  ...
  "registry+https://github.com/rust-lang/crates.io-index".aws-lc-rs."1.11.1" = overridableMkRustCrate (profileName: rec {
    name = "aws-lc-rs";
    version = "1.11.1";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "f47bb8cc16b669d267eeccf585aea077d0882f4777b1c1f740217885d6e6e5a3"; };
    features = builtins.concatLists [
      [ "aws-lc-sys" ]
      [ "prebuilt-nasm" ]
    ];
    dependencies = {
      aws_lc_sys = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".aws-lc-sys."0.23.1" { inherit profileName; }).out;
      paste = (buildRustPackages."registry+https://github.com/rust-lang/crates.io-index".paste."1.0.15" { profileName = "__noProfile"; }).out;
      zeroize = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".zeroize."1.8.1" { inherit profileName; }).out;
    };
  });
  
  "registry+https://github.com/rust-lang/crates.io-index".aws-lc-sys."0.23.1" = overridableMkRustCrate (profileName: rec {
    name = "aws-lc-sys";
    version = "0.23.1";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "a2101df3813227bbaaaa0b04cd61c534c7954b22bd68d399b440be937dc63ff7"; };
    features = builtins.concatLists [
      [ "prebuilt-nasm" ]
    ];
    dependencies = {
  ...
  "registry+https://github.com/rust-lang/crates.io-index".aws-runtime."1.4.4" = overridableMkRustCrate (profileName: rec {
    name = "aws-runtime";
    version = "1.4.4";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "b5ac934720fbb46206292d2c75b57e67acfc56fe7dfd34fb9a02334af08409ea"; };
    features = builtins.concatLists [
      [ "event-stream" ]
      [ "http-02x" ]
      [ "sigv4a" ]
    ...
    dependencies = {
      aws_credential_types = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".aws-credential-types."1.2.1" { inherit profileName; }).out;
      aws_sigv4 = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".aws-sigv4."1.2.6" { inherit profileName; }).out;
      aws_smithy_async = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".aws-smithy-async."1.2.1" { inherit profileName; }).out;
      aws_smithy_eventstream = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".aws-smithy-eventstream."0.60.5" { inherit profileName; }).out;
      aws_smithy_http = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".aws-smithy-http."0.60.11" { inherit profileName; }).out;
      aws_smithy_runtime = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".aws-smithy-runtime."1.7.4" { inherit profileName; }).out;
      aws_smithy_runtime_api = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".aws-smithy-runtime-api."1.7.3" { inherit profileName; }).out;
      aws_smithy_types = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".aws-smithy-types."1.2.9" { inherit profileName; }).out;
  ...
  "registry+https://github.com/rust-lang/crates.io-index".aws-sdk-s3."1.65.0" = overridableMkRustCrate (profileName: rec {
    name = "aws-sdk-s3";
    version = "1.65.0";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "d3ba2c5c0f2618937ce3d4a5ad574b86775576fa24006bcb3128c6e2cbf3c34e"; };
    features = builtins.concatLists [
      [ "default" ]
      [ "rt-tokio" ]
      [ "rustls" ]
    ...
    dependencies = {
      ...
      aws_sigv4 = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".aws-sigv4."1.2.6" { inherit profileName; }).out;
      aws_smithy_async = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".aws-smithy-async."1.2.1" { inherit profileName; }).out;
      aws_smithy_checksums = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".aws-smithy-checksums."0.60.13" { inherit profileName; }).out;
      aws_smithy_eventstream = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".aws-smithy-eventstream."0.60.5" { inherit profileName; }).out;
      aws_smithy_http = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".aws-smithy-http."0.60.11" { inherit profileName; }).out;
      aws_smithy_json = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".aws-smithy-json."0.61.1" { inherit profileName; }).out;
      aws_smithy_runtime = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".aws-smithy-runtime."1.7.4" { inherit profileName; }).out;
      aws_smithy_runtime_api = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".aws-smithy-runtime-api."1.7.3" { inherit profileName; }).out;
      aws_smithy_types = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".aws-smithy-types."1.2.9" { inherit profileName; }).out;
  ...
  "registry+https://github.com/rust-lang/crates.io-index".aws-sdk-sso."1.50.0" = overridableMkRustCrate (profileName: rec {
    name = "aws-sdk-sso";
    version = "1.50.0";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "05ca43a4ef210894f93096039ef1d6fa4ad3edfabb3be92b80908b9f2e4b4eab"; };
    dependencies = {
      aws_credential_types = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".aws-credential-types."1.2.1" { inherit profileName; }).out;
      aws_runtime = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".aws-runtime."1.4.4" { inherit profileName; }).out;
      aws_smithy_async = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".aws-smithy-async."1.2.1" { inherit profileName; }).out;
  ...
  "registry+https://github.com/rust-lang/crates.io-index".aws-sdk-ssooidc."1.51.0" = overridableMkRustCrate (profileName: rec {
    name = "aws-sdk-ssooidc";
    version = "1.51.0";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "abaf490c2e48eed0bb8e2da2fb08405647bd7f253996e0f93b981958ea0f73b0"; };
    dependencies = {
      aws_credential_types = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".aws-credential-types."1.2.1" { inherit profileName; }).out;
      aws_runtime = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".aws-runtime."1.4.4" { inherit profileName; }).out;
      aws_smithy_async = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".aws-smithy-async."1.2.1" { inherit profileName; }).out;
  ...
  "registry+https://github.com/rust-lang/crates.io-index".aws-sdk-sts."1.51.0" = overridableMkRustCrate (profileName: rec {
    name = "aws-sdk-sts";
    version = "1.51.0";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "b68fde0d69c8bfdc1060ea7da21df3e39f6014da316783336deff0a9ec28f4bf"; };
    dependencies = {
      aws_credential_types = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".aws-credential-types."1.2.1" { inherit profileName; }).out;
      aws_runtime = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".aws-runtime."1.4.4" { inherit profileName; }).out;
      aws_smithy_async = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".aws-smithy-async."1.2.1" { inherit profileName; }).out;
  ...
  "registry+https://github.com/rust-lang/crates.io-index".aws-sigv4."1.2.6" = overridableMkRustCrate (profileName: rec {
    name = "aws-sigv4";
    version = "1.2.6";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "7d3820e0c08d0737872ff3c7c1f21ebbb6693d832312d6152bf18ef50a5471c2"; };
    features = builtins.concatLists [
      [ "default" ]
      [ "http0-compat" ]
      [ "http1" ]
  ...
  "registry+https://github.com/rust-lang/crates.io-index".aws-smithy-checksums."0.60.13" = overridableMkRustCrate (profileName: rec {
    name = "aws-smithy-checksums";
    version = "0.60.13";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "ba1a71073fca26775c8b5189175ea8863afb1c9ea2cceb02a5de5ad9dfbaa795"; };
    dependencies = {
      aws_smithy_http = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".aws-smithy-http."0.60.11" { inherit profileName; }).out;
      aws_smithy_types = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".aws-smithy-types."1.2.9" { inherit profileName; }).out;
      bytes = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".bytes."1.9.0" { inherit profileName; }).out;
  ...
  "registry+https://github.com/rust-lang/crates.io-index".aws-smithy-eventstream."0.60.5" = overridableMkRustCrate (profileName: rec {
    name = "aws-smithy-eventstream";
    version = "0.60.5";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "cef7d0a272725f87e51ba2bf89f8c21e4df61b9e49ae1ac367a6d69916ef7c90"; };
    dependencies = {
      aws_smithy_types = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".aws-smithy-types."1.2.9" { inherit profileName; }).out;
      bytes = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".bytes."1.9.0" { inherit profileName; }).out;
      crc32fast = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".crc32fast."1.4.2" { inherit profileName; }).out;
  ...
  "registry+https://github.com/rust-lang/crates.io-index".aws-smithy-json."0.61.1" = overridableMkRustCrate (profileName: rec {
    name = "aws-smithy-json";
    version = "0.61.1";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "ee4e69cc50921eb913c6b662f8d909131bb3e6ad6cb6090d3a39b66fc5c52095"; };
    dependencies = {
      aws_smithy_types = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".aws-smithy-types."1.2.9" { inherit profileName; }).out;
    };
  });
  ...
  "registry+https://github.com/rust-lang/crates.io-index".aws-smithy-runtime."1.7.4" = overridableMkRustCrate (profileName: rec {
    name = "aws-smithy-runtime";
    version = "1.7.4";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "9f20685047ca9d6f17b994a07f629c813f08b5bce65523e47124879e60103d45"; };
    features = builtins.concatLists [
      [ "client" ]
  ...
  "registry+https://github.com/rust-lang/crates.io-index".aws-smithy-types."1.2.9" = overridableMkRustCrate (profileName: rec {
    name = "aws-smithy-types";
    version = "1.2.9";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "4fbd94a32b3a7d55d3806fe27d98d3ad393050439dd05eb53ece36ec5e3d3510"; };
    features = builtins.concatLists [
    ...
    dependencies = {
      ...
      ${ if false then "serde" else null } = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".serde."1.0.215" { inherit profileName; }).out;
      time = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".time."0.3.37" { inherit profileName; }).out;
      tokio = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".tokio."1.42.0" { inherit profileName; }).out;
  ...
  "registry+https://github.com/rust-lang/crates.io-index".axum-prometheus."0.7.0" = overridableMkRustCrate (profileName: rec {
    name = "axum-prometheus";
    version = "0.7.0";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "739e2585f5376f5bdd129324ded72d3261fdd5b7c411a645920328fb5dc875d4"; };
    features = builtins.concatLists [
      [ "default" ]
    ...
    dependencies = {
      ...
      http_body = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".http-body."1.0.1" { inherit profileName; }).out;
      matchit = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".matchit."0.7.3" { inherit profileName; }).out;
      metrics = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".metrics."0.23.0" { inherit profileName; }).out;
      metrics_exporter_prometheus = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".metrics-exporter-prometheus."0.15.3" { inherit profileName; }).out;
      once_cell = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".once_cell."1.20.2" { inherit profileName; }).out;
  ...
  "unknown".chir-rs-castore."0.1.0" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      aws_config = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".aws-config."1.5.10" { inherit profileName; }).out;
      aws_sdk_s3 = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".aws-sdk-s3."1.65.0" { inherit profileName; }).out;
  ...
  "unknown".chir-rs-http."0.1.0" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      ...
      axum = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".axum."0.7.9" { inherit profileName; }).out;
      axum_prometheus = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".axum-prometheus."0.7.0" { inherit profileName; }).out;
  ...
  "unknown".chir-rs-http-api."0.1.0" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      ...
      mime = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".mime."0.3.17" { inherit profileName; }).out;
      serde = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".serde."1.0.215" { inherit profileName; }).out;
      thiserror = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".thiserror."2.0.6" { inherit profileName; }).out;
      tracing = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".tracing."0.1.41" { inherit profileName; }).out;
    };
  });
  ...
  "registry+https://github.com/rust-lang/crates.io-index".cmake."0.1.52" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      cc = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".cc."1.2.3" { inherit profileName; }).out;
    };
  });
  ...
  "registry+https://github.com/rust-lang/crates.io-index".hostname."0.4.0" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      cfg_if = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".cfg-if."1.0.0" { inherit profileName; }).out;
      ${ if hostPlatform.isUnix || hostPlatform.parsed.kernel.name == "redox" then "libc" else null } = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".libc."0.2.168" { inherit profileName; }).out;
  ...
  "registry+https://github.com/rust-lang/crates.io-index".metrics."0.23.0" = overridableMkRustCrate (profileName: rec {
    name = "metrics";
    version = "0.23.0";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "884adb57038347dfbaf2d5065887b6cf4312330dc8e94bc30a1a839bd79d3261"; };
    dependencies = {
      ahash = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".ahash."0.8.11" { inherit profileName; }).out;
  ...
  "registry+https://github.com/rust-lang/crates.io-index".metrics-exporter-prometheus."0.15.3" = overridableMkRustCrate (profileName: rec {
    name = "metrics-exporter-prometheus";
    version = "0.15.3";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "b4f0c8427b39666bf970460908b213ec09b3b350f20c0c2eabcbba51704a08e6"; };
    features = builtins.concatLists [
      [ "_hyper-server" ]
      [ "async-runtime" ]
      [ "http-body-util" ]
    ...
    dependencies = {
      ...
      metrics = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".metrics."0.23.0" { inherit profileName; }).out;
      metrics_util = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".metrics-util."0.17.0" { inherit profileName; }).out;
      quanta = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".quanta."0.12.3" { inherit profileName; }).out;
      thiserror = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".thiserror."1.0.69" { inherit profileName; }).out;
      tokio = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".tokio."1.42.0" { inherit profileName; }).out;
      tracing = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".tracing."0.1.41" { inherit profileName; }).out;
    };
  ...
  "registry+https://github.com/rust-lang/crates.io-index".metrics-util."0.17.0" = overridableMkRustCrate (profileName: rec {
    name = "metrics-util";
    version = "0.17.0";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "4259040465c955f9f2f1a4a8a16dc46726169bca0f88e8fb2dbeced487c3e828"; };
    features = builtins.concatLists [
      [ "crossbeam-epoch" ]
      [ "crossbeam-utils" ]
      [ "handles" ]
  ...
  "registry+https://github.com/rust-lang/crates.io-index".num_cpus."1.16.0" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      ...
      ${ if !hostPlatform.isWindows then "libc" else null } = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".libc."0.2.168" { inherit profileName; }).out;
    };
  });
  ...
  "registry+https://github.com/rust-lang/crates.io-index".num_threads."0.1.7" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      ${ if hostPlatform.parsed.kernel.name == "darwin" || hostPlatform.parsed.kernel.name == "ios" || hostPlatform.parsed.kernel.name == "freebsd" then "libc" else null } = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".libc."0.2.168" { inherit profileName; }).out;
    };
  });
  ...
  "registry+https://github.com/rust-lang/crates.io-index".os_info."3.9.0" = overridableMkRustCrate (profileName: rec {
    name = "os_info";
    version = "3.9.0";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "e5ca711d8b83edbb00b44d504503cd247c9c0bd8b0fa2694f2a1a3d8165379ce"; };
    features = builtins.concatLists [
      [ "default" ]
      [ "serde" ]
    ];
  ...
  "registry+https://github.com/rust-lang/crates.io-index".quanta."0.12.3" = overridableMkRustCrate (profileName: rec {
    name = "quanta";
    version = "0.12.3";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "8e5167a477619228a0b284fac2674e3c388cba90631d7b7de620e6f1fcd08da5"; };
    dependencies = {
      crossbeam_utils = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".crossbeam-utils."0.8.20" { inherit profileName; }).out;
      ${ if !(hostPlatform.parsed.kernel.name == "windows" || hostPlatform.parsed.cpu.name == "wasm32") then "libc" else null } = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".libc."0.2.168" { inherit profileName; }).out;
      once_cell = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".once_cell."1.20.2" { inherit profileName; }).out;
      ${ if hostPlatform.parsed.cpu.name == "i686" || hostPlatform.parsed.cpu.name == "x86_64" then "raw_cpuid" else null } = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".raw-cpuid."11.2.0" { inherit profileName; }).out;
  ...
  "registry+https://github.com/rust-lang/crates.io-index".quinn."0.11.6" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      ...
      udp = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".quinn-udp."0.5.8" { inherit profileName; }).out;
  ...
  "registry+https://github.com/rust-lang/crates.io-index".quinn-proto."0.11.9" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      ...
      rustc_hash = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".rustc-hash."2.1.0" { inherit profileName; }).out;
      rustls = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".rustls."0.23.19" { inherit profileName; }).out;
      ${ if false then "rustls_pki_types" else null } = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".rustls-pki-types."1.10.0" { inherit profileName; }).out;
      slab = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".slab."0.4.9" { inherit profileName; }).out;
      thiserror = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".thiserror."2.0.6" { inherit profileName; }).out;
  ...
  "registry+https://github.com/rust-lang/crates.io-index".quinn-udp."0.5.8" = overridableMkRustCrate (profileName: rec {
    name = "quinn-udp";
    version = "0.5.8";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "52cd4b1eff68bf27940dd39811292c49e007f4d0b4c357358dc9b0197be6b527"; };
    features = builtins.concatLists [
      [ "tracing" ]
    ];
    dependencies = {
  ...
  "registry+https://github.com/rust-lang/crates.io-index".raw-cpuid."11.2.0" = overridableMkRustCrate (profileName: rec {
    name = "raw-cpuid";
    version = "11.2.0";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "1ab240315c661615f2ee9f0f2cd32d5a7343a84d5ebcccb99d46e6637565e7b0"; };
    dependencies = {
      bitflags = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".bitflags."2.6.0" { inherit profileName; }).out;
    };
  });
  ...
  "registry+https://github.com/rust-lang/crates.io-index".reqwest."0.12.9" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      ...
      ${ if !(hostPlatform.parsed.cpu.name == "wasm32") then "rustls" else null } = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".rustls."0.23.19" { inherit profileName; }).out;
  ...
  "registry+https://github.com/rust-lang/crates.io-index".rustls."0.23.19" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      aws_lc_rs = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".aws-lc-rs."1.11.1" { inherit profileName; }).out;
      log = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".log."0.4.22" { inherit profileName; }).out;
      once_cell = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".once_cell."1.20.2" { inherit profileName; }).out;
      ring = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".ring."0.17.8" { inherit profileName; }).out;
      pki_types = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".rustls-pki-types."1.10.0" { inherit profileName; }).out;
  ...
  "registry+https://github.com/rust-lang/crates.io-index".sentry-contexts."0.34.0" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      ...
      libc = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".libc."0.2.168" { inherit profileName; }).out;
      ${ if hostPlatform.isWindows then "os_info" else null } = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".os_info."3.9.0" { inherit profileName; }).out;
      sentry_core = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".sentry-core."0.34.0" { inherit profileName; }).out;
  ...
  "registry+https://github.com/rust-lang/crates.io-index".thiserror."2.0.6" = overridableMkRustCrate (profileName: rec {
    name = "thiserror";
    version = "2.0.6";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "8fec2a1820ebd077e2b90c4df007bebf344cd394098a13c563957d0afc83ea47"; };
    features = builtins.concatLists [
      [ "default" ]
      [ "std" ]
    ];
    dependencies = {
      thiserror_impl = (buildRustPackages."registry+https://github.com/rust-lang/crates.io-index".thiserror-impl."2.0.6" { profileName = "__noProfile"; }).out;
    };
  });
  ...
  "registry+https://github.com/rust-lang/crates.io-index".thiserror-impl."2.0.6" = overridableMkRustCrate (profileName: rec {
    name = "thiserror-impl";
    version = "2.0.6";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "d65750cab40f4ff1929fb1ba509e9914eb756131cef4210da8d5d700d26f6312"; };
    dependencies = {
      proc_macro2 = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".proc-macro2."1.0.92" { inherit profileName; }).out;
      quote = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".quote."1.0.37" { inherit profileName; }).out;
      syn = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".syn."2.0.90" { inherit profileName; }).out;
  ...
  "registry+https://github.com/rust-lang/crates.io-index".walrus."0.23.2" = overridableMkRustCrate (profileName: rec {
    name = "walrus";
    version = "0.23.2";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "031bc51853697a6a01731f1c2d6d56989c3a742d63316f59918c90b709a6edd9"; };
    features = builtins.concatLists [
      [ "parallel" ]
      [ "rayon" ]
    ];
  ...
  "registry+https://github.com/rust-lang/crates.io-index".wasm-bindgen-cli."0.2.99" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      ...
      serde_json = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".serde_json."1.0.133" { inherit profileName; }).out;
      ureq = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".ureq."2.12.1" { inherit profileName; }).out;
      walrus = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".walrus."0.23.2" { inherit profileName; }).out;
