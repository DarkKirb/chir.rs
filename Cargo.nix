...
let
  nixifiedLockHash = "320093dda63958fe81f9f95cc9bda88ee1f8175a9046ca0345a96a05ba5ff348";
...
in
{
  ...
  "registry+https://github.com/rust-lang/crates.io-index".anstyle-wincon."3.0.7" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      anstyle = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".anstyle."1.0.10" { inherit profileName; }).out;
      ${ if hostPlatform.isWindows then "once_cell" else null } = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".once_cell."1.21.1" { inherit profileName; }).out;
      ${ if hostPlatform.isWindows then "windows_sys" else null } = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".windows-sys."0.59.0" { inherit profileName; }).out;
    };
  });
  ...
  "registry+https://github.com/rust-lang/crates.io-index".aws-config."1.6.0" = overridableMkRustCrate (profileName: rec {
    name = "aws-config";
    version = "1.6.0";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "6a84fe2c5e9965fba0fbc2001db252f1d57527d82a905cca85127df227bca748"; };
    features = builtins.concatLists [
    ...
    dependencies = {
      aws_credential_types = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".aws-credential-types."1.2.2" { inherit profileName; }).out;
      aws_runtime = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".aws-runtime."1.5.6" { inherit profileName; }).out;
      aws_sdk_sso = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".aws-sdk-sso."1.62.0" { inherit profileName; }).out;
      aws_sdk_ssooidc = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".aws-sdk-ssooidc."1.63.0" { inherit profileName; }).out;
      aws_sdk_sts = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".aws-sdk-sts."1.63.0" { inherit profileName; }).out;
      aws_smithy_async = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".aws-smithy-async."1.2.5" { inherit profileName; }).out;
      aws_smithy_http = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".aws-smithy-http."0.62.0" { inherit profileName; }).out;
      aws_smithy_json = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".aws-smithy-json."0.61.3" { inherit profileName; }).out;
      aws_smithy_runtime = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".aws-smithy-runtime."1.8.1" { inherit profileName; }).out;
      aws_smithy_runtime_api = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".aws-smithy-runtime-api."1.7.4" { inherit profileName; }).out;
      aws_smithy_types = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".aws-smithy-types."1.3.0" { inherit profileName; }).out;
      aws_types = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".aws-types."1.3.6" { inherit profileName; }).out;
  ...
  "registry+https://github.com/rust-lang/crates.io-index".aws-credential-types."1.2.2" = overridableMkRustCrate (profileName: rec {
    name = "aws-credential-types";
    version = "1.2.2";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "4471bef4c22a06d2c7a1b6492493d3fdf24a805323109d6874f9c94d5906ac14"; };
    features = builtins.concatLists [
      [ "test-util" ]
    ];
    dependencies = {
  ...
  "registry+https://github.com/rust-lang/crates.io-index".aws-lc-rs."1.12.6" = overridableMkRustCrate (profileName: rec {
    name = "aws-lc-rs";
    version = "1.12.6";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "dabb68eb3a7aa08b46fddfd59a3d55c978243557a90ab804769f7e20e67d2b01"; };
    features = builtins.concatLists [
      [ "aws-lc-sys" ]
      [ "prebuilt-nasm" ]
    ];
    dependencies = {
      aws_lc_sys = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".aws-lc-sys."0.27.1" { inherit profileName; }).out;
      zeroize = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".zeroize."1.8.1" { inherit profileName; }).out;
    };
  });
  
  "registry+https://github.com/rust-lang/crates.io-index".aws-lc-sys."0.27.1" = overridableMkRustCrate (profileName: rec {
    name = "aws-lc-sys";
    version = "0.27.1";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "77926887776171ced7d662120a75998e444d3750c951abfe07f90da130514b1f"; };
    features = builtins.concatLists [
      [ "prebuilt-nasm" ]
    ];
    buildDependencies = {
  ...
  "registry+https://github.com/rust-lang/crates.io-index".aws-runtime."1.5.6" = overridableMkRustCrate (profileName: rec {
    name = "aws-runtime";
    version = "1.5.6";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "0aff45ffe35196e593ea3b9dd65b320e51e2dda95aff4390bc459e461d09c6ad"; };
    features = builtins.concatLists [
      [ "event-stream" ]
      [ "http-02x" ]
      [ "sigv4a" ]
    ...
    dependencies = {
      aws_credential_types = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".aws-credential-types."1.2.2" { inherit profileName; }).out;
      aws_sigv4 = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".aws-sigv4."1.3.0" { inherit profileName; }).out;
      aws_smithy_async = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".aws-smithy-async."1.2.5" { inherit profileName; }).out;
      aws_smithy_eventstream = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".aws-smithy-eventstream."0.60.8" { inherit profileName; }).out;
      aws_smithy_http = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".aws-smithy-http."0.62.0" { inherit profileName; }).out;
      aws_smithy_runtime = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".aws-smithy-runtime."1.8.1" { inherit profileName; }).out;
      aws_smithy_runtime_api = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".aws-smithy-runtime-api."1.7.4" { inherit profileName; }).out;
      aws_smithy_types = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".aws-smithy-types."1.3.0" { inherit profileName; }).out;
  ...
  "registry+https://github.com/rust-lang/crates.io-index".aws-sdk-s3."1.79.0" = overridableMkRustCrate (profileName: rec {
    name = "aws-sdk-s3";
    version = "1.79.0";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "a8f63ba8f5fca32061c7d62d866ef65470edde38d4c5f8a0ebb8ff40a0521e1c"; };
    features = builtins.concatLists [
      [ "default" ]
      [ "default-https-client" ]
      [ "rt-tokio" ]
    ...
    dependencies = {
      ...
      aws_sigv4 = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".aws-sigv4."1.3.0" { inherit profileName; }).out;
      aws_smithy_async = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".aws-smithy-async."1.2.5" { inherit profileName; }).out;
      aws_smithy_checksums = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".aws-smithy-checksums."0.63.1" { inherit profileName; }).out;
      aws_smithy_eventstream = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".aws-smithy-eventstream."0.60.8" { inherit profileName; }).out;
      aws_smithy_http = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".aws-smithy-http."0.62.0" { inherit profileName; }).out;
      aws_smithy_json = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".aws-smithy-json."0.61.3" { inherit profileName; }).out;
      aws_smithy_runtime = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".aws-smithy-runtime."1.8.1" { inherit profileName; }).out;
  ...
  "registry+https://github.com/rust-lang/crates.io-index".aws-sdk-sso."1.62.0" = overridableMkRustCrate (profileName: rec {
    name = "aws-sdk-sso";
    version = "1.62.0";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "1d5330ad4e8a1ff49e9f26b738611caa72b105c41d41733801d1a36e8f9de936"; };
    dependencies = {
      aws_credential_types = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".aws-credential-types."1.2.2" { inherit profileName; }).out;
      aws_runtime = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".aws-runtime."1.5.6" { inherit profileName; }).out;
      aws_smithy_async = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".aws-smithy-async."1.2.5" { inherit profileName; }).out;
  ...
  "registry+https://github.com/rust-lang/crates.io-index".aws-sdk-ssooidc."1.63.0" = overridableMkRustCrate (profileName: rec {
    name = "aws-sdk-ssooidc";
    version = "1.63.0";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "7956b1a85d49082347a7d17daa2e32df191f3e23c03d47294b99f95413026a78"; };
    dependencies = {
      aws_credential_types = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".aws-credential-types."1.2.2" { inherit profileName; }).out;
      aws_runtime = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".aws-runtime."1.5.6" { inherit profileName; }).out;
      aws_smithy_async = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".aws-smithy-async."1.2.5" { inherit profileName; }).out;
  ...
  "registry+https://github.com/rust-lang/crates.io-index".aws-sdk-sts."1.63.0" = overridableMkRustCrate (profileName: rec {
    name = "aws-sdk-sts";
    version = "1.63.0";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "065c533fbe6f84962af33fcf02b0350b7c1f79285baab5924615d2be3b232855"; };
    dependencies = {
      aws_credential_types = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".aws-credential-types."1.2.2" { inherit profileName; }).out;
      aws_runtime = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".aws-runtime."1.5.6" { inherit profileName; }).out;
      aws_smithy_async = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".aws-smithy-async."1.2.5" { inherit profileName; }).out;
  ...
  "registry+https://github.com/rust-lang/crates.io-index".aws-sigv4."1.3.0" = overridableMkRustCrate (profileName: rec {
    name = "aws-sigv4";
    version = "1.3.0";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "69d03c3c05ff80d54ff860fe38c726f6f494c639ae975203a101335f223386db"; };
    features = builtins.concatLists [
      [ "default" ]
      [ "http0-compat" ]
      [ "http1" ]
  ...
  "registry+https://github.com/rust-lang/crates.io-index".aws-smithy-async."1.2.5" = overridableMkRustCrate (profileName: rec {
    name = "aws-smithy-async";
    version = "1.2.5";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "1e190749ea56f8c42bf15dd76c65e14f8f765233e6df9b0506d9d934ebef867c"; };
    features = builtins.concatLists [
      [ "rt-tokio" ]
    ];
    dependencies = {
  ...
  "registry+https://github.com/rust-lang/crates.io-index".aws-smithy-checksums."0.63.1" = overridableMkRustCrate (profileName: rec {
    name = "aws-smithy-checksums";
    version = "0.63.1";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "b65d21e1ba6f2cdec92044f904356a19f5ad86961acf015741106cdfafd747c0"; };
    dependencies = {
      aws_smithy_http = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".aws-smithy-http."0.62.0" { inherit profileName; }).out;
      aws_smithy_types = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".aws-smithy-types."1.3.0" { inherit profileName; }).out;
      bytes = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".bytes."1.10.1" { inherit profileName; }).out;
      ...
      crc64fast_nvme = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".crc64fast-nvme."1.2.0" { inherit profileName; }).out;
      hex = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".hex."0.4.3" { inherit profileName; }).out;
      http = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".http."0.2.12" { inherit profileName; }).out;
      http_body = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".http-body."0.4.6" { inherit profileName; }).out;
  ...
  "registry+https://github.com/rust-lang/crates.io-index".aws-smithy-eventstream."0.60.8" = overridableMkRustCrate (profileName: rec {
    name = "aws-smithy-eventstream";
    version = "0.60.8";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "7c45d3dddac16c5c59d553ece225a88870cf81b7b813c9cc17b78cf4685eac7a"; };
    dependencies = {
      aws_smithy_types = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".aws-smithy-types."1.3.0" { inherit profileName; }).out;
      bytes = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".bytes."1.10.1" { inherit profileName; }).out;
      crc32fast = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".crc32fast."1.4.2" { inherit profileName; }).out;
  ...
  "registry+https://github.com/rust-lang/crates.io-index".aws-smithy-http."0.62.0" = overridableMkRustCrate (profileName: rec {
    name = "aws-smithy-http";
    version = "0.62.0";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "c5949124d11e538ca21142d1fba61ab0a2a2c1bc3ed323cdb3e4b878bfb83166"; };
    features = builtins.concatLists [
  ...
  "registry+https://github.com/rust-lang/crates.io-index".aws-smithy-http-client."1.0.0" = overridableMkRustCrate (profileName: rec {
    name = "aws-smithy-http-client";
    version = "1.0.0";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "0497ef5d53065b7cd6a35e9c1654bd1fefeae5c52900d91d1b188b0af0f29324"; };
    features = builtins.concatLists [
      [ "default-client" ]
      [ "hyper-014" ]
      [ "legacy-rustls-ring" ]
    ...
    dependencies = {
      ...
      hyper_rustls = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".hyper-rustls."0.27.5" { inherit profileName; }).out;
      ...
      rustls = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".rustls."0.23.25" { inherit profileName; }).out;
      ...
      rustls_pki_types = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".rustls-pki-types."1.11.0" { inherit profileName; }).out;
      tokio = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".tokio."1.44.1" { inherit profileName; }).out;
  ...
  "registry+https://github.com/rust-lang/crates.io-index".aws-smithy-json."0.61.3" = overridableMkRustCrate (profileName: rec {
    name = "aws-smithy-json";
    version = "0.61.3";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "92144e45819cae7dc62af23eac5a038a58aa544432d2102609654376a900bd07"; };
    dependencies = {
      aws_smithy_types = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".aws-smithy-types."1.3.0" { inherit profileName; }).out;
    };
  });
  
  "registry+https://github.com/rust-lang/crates.io-index".aws-smithy-observability."0.1.2" = overridableMkRustCrate (profileName: rec {
    name = "aws-smithy-observability";
    version = "0.1.2";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "445d065e76bc1ef54963db400319f1dd3ebb3e0a74af20f7f7630625b0cc7cc0"; };
    dependencies = {
      aws_smithy_runtime_api = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".aws-smithy-runtime-api."1.7.4" { inherit profileName; }).out;
      once_cell = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".once_cell."1.21.1" { inherit profileName; }).out;
    };
  ...
  "registry+https://github.com/rust-lang/crates.io-index".aws-smithy-runtime."1.8.1" = overridableMkRustCrate (profileName: rec {
    name = "aws-smithy-runtime";
    version = "1.8.1";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "0152749e17ce4d1b47c7747bdfec09dac1ccafdcbc741ebf9daa2a373356730f"; };
    features = builtins.concatLists [
      [ "client" ]
    ...
    dependencies = {
      aws_smithy_async = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".aws-smithy-async."1.2.5" { inherit profileName; }).out;
      aws_smithy_http = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".aws-smithy-http."0.62.0" { inherit profileName; }).out;
      aws_smithy_http_client = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".aws-smithy-http-client."1.0.0" { inherit profileName; }).out;
      aws_smithy_observability = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".aws-smithy-observability."0.1.2" { inherit profileName; }).out;
      aws_smithy_runtime_api = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".aws-smithy-runtime-api."1.7.4" { inherit profileName; }).out;
      aws_smithy_types = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".aws-smithy-types."1.3.0" { inherit profileName; }).out;
      bytes = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".bytes."1.10.1" { inherit profileName; }).out;
      fastrand = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".fastrand."2.3.0" { inherit profileName; }).out;
  ...
  "registry+https://github.com/rust-lang/crates.io-index".aws-smithy-runtime-api."1.7.4" = overridableMkRustCrate (profileName: rec {
    name = "aws-smithy-runtime-api";
    version = "1.7.4";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "3da37cf5d57011cb1753456518ec76e31691f1f474b73934a284eb2a1c76510f"; };
    features = builtins.concatLists [
      [ "client" ]
      [ "default" ]
      [ "http-02x" ]
  ...
  "registry+https://github.com/rust-lang/crates.io-index".aws-smithy-types."1.3.0" = overridableMkRustCrate (profileName: rec {
    name = "aws-smithy-types";
    version = "1.3.0";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "836155caafba616c0ff9b07944324785de2ab016141c3550bd1c07882f8cee8f"; };
    features = builtins.concatLists [
  ...
  "registry+https://github.com/rust-lang/crates.io-index".aws-types."1.3.6" = overridableMkRustCrate (profileName: rec {
    name = "aws-types";
    version = "1.3.6";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "3873f8deed8927ce8d04487630dc9ff73193bab64742a61d050e57a68dec4125"; };
    dependencies = {
      aws_credential_types = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".aws-credential-types."1.2.2" { inherit profileName; }).out;
      aws_smithy_async = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".aws-smithy-async."1.2.5" { inherit profileName; }).out;
      aws_smithy_runtime_api = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".aws-smithy-runtime-api."1.7.4" { inherit profileName; }).out;
  ...
  "registry+https://github.com/rust-lang/crates.io-index".axum."0.8.1" = overridableMkRustCrate (profileName: rec {
    name = "axum";
    version = "0.8.1";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "6d6fd624c75e18b3b4c6b9caf42b1afe24437daaee904069137d8bab077be8b8"; };
    features = builtins.concatLists [
      [ "default" ]
      [ "form" ]
      [ "http1" ]
    ...
    dependencies = {
      axum_core = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".axum-core."0.5.0" { inherit profileName; }).out;
      bytes = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".bytes."1.10.1" { inherit profileName; }).out;
      form_urlencoded = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".form_urlencoded."1.2.1" { inherit profileName; }).out;
      futures_util = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".futures-util."0.3.31" { inherit profileName; }).out;
      http = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".http."1.3.1" { inherit profileName; }).out;
  ...
  "registry+https://github.com/rust-lang/crates.io-index".axum-core."0.5.0" = overridableMkRustCrate (profileName: rec {
    name = "axum-core";
    version = "0.5.0";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "df1362f362fd16024ae199c1970ce98f9661bf5ef94b9808fee734bc3698b733"; };
    features = builtins.concatLists [
      [ "tracing" ]
    ];
    dependencies = {
  ...
  "registry+https://github.com/rust-lang/crates.io-index".axum-prometheus."0.8.0" = overridableMkRustCrate (profileName: rec {
    name = "axum-prometheus";
    version = "0.8.0";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "42e1a6651f119707ec6c416f38fdb5be223707627fe6d47f912850634c106215"; };
    features = builtins.concatLists [
      [ "default" ]
    ...
    dependencies = {
      axum = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".axum."0.8.1" { inherit profileName; }).out;
      bytes = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".bytes."1.10.1" { inherit profileName; }).out;
      futures_core = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".futures-core."0.3.31" { inherit profileName; }).out;
      http = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".http."1.3.1" { inherit profileName; }).out;
      http_body = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".http-body."1.0.1" { inherit profileName; }).out;
      matchit = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".matchit."0.8.4" { inherit profileName; }).out;
      metrics = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".metrics."0.24.1" { inherit profileName; }).out;
      metrics_exporter_prometheus = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".metrics-exporter-prometheus."0.16.2" { inherit profileName; }).out;
  ...
  "registry+https://github.com/rust-lang/crates.io-index".b64-ct."0.1.3" = overridableMkRustCrate (profileName: rec {
    name = "b64-ct";
    version = "0.1.3";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "41dd1e07aafe656df62d40e74d4627a0cce26da43b0bec233ac1305207a5a768"; };
    features = builtins.concatLists [
      [ "default" ]
      [ "std" ]
    ];
  ...
  "registry+https://github.com/rust-lang/crates.io-index".bincode."2.0.1" = overridableMkRustCrate (profileName: rec {
    name = "bincode";
    version = "2.0.1";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "36eaf5d7b090263e8150820482d5d93cd964a81e4019913c972f4edcc6edb740"; };
    features = builtins.concatLists [
      [ "alloc" ]
      [ "bincode_derive" ]
      [ "default" ]
    ...
    dependencies = {
      bincode_derive = (buildRustPackages."registry+https://github.com/rust-lang/crates.io-index".bincode_derive."2.0.1" { profileName = "__noProfile"; }).out;
      serde = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".serde."1.0.219" { inherit profileName; }).out;
      unty = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".unty."0.0.4" { inherit profileName; }).out;
    };
  });
  
  "registry+https://github.com/rust-lang/crates.io-index".bincode_derive."2.0.1" = overridableMkRustCrate (profileName: rec {
    name = "bincode_derive";
    version = "2.0.1";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "bf95709a440f45e986983918d0e8a1f30a9b1df04918fc828670606804ac3c09"; };
    dependencies = {
      virtue = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".virtue."0.0.18" { inherit profileName; }).out;
    };
  });
  ...
  "registry+https://github.com/rust-lang/crates.io-index".blake3."1.7.0" = overridableMkRustCrate (profileName: rec {
    name = "blake3";
    version = "1.7.0";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "b17679a8d69b6d7fd9cd9801a536cec9fa5e5970b69f9d4747f70b39b031f5e7"; };
    features = builtins.concatLists [
      [ "default" ]
      [ "rayon" ]
      [ "serde" ]
  ...
  "registry+https://github.com/rust-lang/crates.io-index".brotli-decompressor."4.0.2" = overridableMkRustCrate (profileName: rec {
    name = "brotli-decompressor";
    version = "4.0.2";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "74fa05ad7d803d413eb8380983b092cbbaf9a85f151b871360e7b00cd7060b37"; };
    features = builtins.concatLists [
      [ "alloc-stdlib" ]
      [ "default" ]
      [ "std" ]
  ...
  "unknown".chir-rs."0.1.0" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      ...
      sentry = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".sentry."0.36.0" { inherit profileName; }).out;
      sentry_eyre = (rustPackages."git+https://github.com/auguwu/sentry-eyre".sentry-eyre."0.2.0" { inherit profileName; }).out;
      sentry_tracing = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".sentry-tracing."0.36.0" { inherit profileName; }).out;
      tokio = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".tokio."1.44.1" { inherit profileName; }).out;
      tracing = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".tracing."0.1.41" { inherit profileName; }).out;
  ...
  "unknown".chir-rs-castore."0.1.0" = overridableMkRustCrate (profileName: rec {
    ...
    src = fetchCrateLocal workspaceSrc;
    dependencies = {
      aws_config = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".aws-config."1.6.0" { inherit profileName; }).out;
      aws_sdk_s3 = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".aws-sdk-s3."1.79.0" { inherit profileName; }).out;
      blake3 = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".blake3."1.7.0" { inherit profileName; }).out;
      bytes = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".bytes."1.10.1" { inherit profileName; }).out;
      chir_rs_config = (rustPackages."unknown".chir-rs-config."0.1.0" { inherit profileName; }).out;
      ...
      eyre = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".eyre."0.6.12" { inherit profileName; }).out;
      stretto = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".stretto."0.8.4" { inherit profileName; }).out;
      tokio = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".tokio."1.44.1" { inherit profileName; }).out;
      tracing = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".tracing."0.1.41" { inherit profileName; }).out;
    };
  });
  ...
  "unknown".chir-rs-client."0.1.0" = overridableMkRustCrate (profileName: rec {
    ...
    src = fetchCrateLocal workspaceSrc;
    dependencies = {
      bincode = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".bincode."2.0.1" { inherit profileName; }).out;
  ...
  "unknown".chir-rs-config."0.1.0" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      eyre = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".eyre."0.6.12" { inherit profileName; }).out;
      sentry_core = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".sentry-core."0.36.0" { inherit profileName; }).out;
      serde = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".serde."1.0.219" { inherit profileName; }).out;
  ...
  "unknown".chir-rs-db."0.1.0" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      ...
      serde = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".serde."1.0.219" { inherit profileName; }).out;
      sqlx = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".sqlx."0.8.3" { inherit profileName; }).out;
      tokio = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".tokio."1.44.1" { inherit profileName; }).out;
      tracing = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".tracing."0.1.41" { inherit profileName; }).out;
    };
  });
  ...
  "unknown".chir-rs-fe."0.1.0" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      ...
      eyre = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".eyre."0.6.12" { inherit profileName; }).out;
      gloo_net = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".gloo-net."0.6.0" { inherit profileName; }).out;
      ...
      wasm_tracing = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".wasm-tracing."2.0.0" { inherit profileName; }).out;
  ...
  "unknown".chir-rs-http."0.1.0" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      ...
      axum = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".axum."0.8.1" { inherit profileName; }).out;
      axum_prometheus = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".axum-prometheus."0.8.0" { inherit profileName; }).out;
      b64_ct = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".b64-ct."0.1.3" { inherit profileName; }).out;
      bincode = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".bincode."2.0.1" { inherit profileName; }).out;
      chir_rs_castore = (rustPackages."unknown".chir-rs-castore."0.1.0" { inherit profileName; }).out;
      chir_rs_config = (rustPackages."unknown".chir-rs-config."0.1.0" { inherit profileName; }).out;
      chir_rs_db = (rustPackages."unknown".chir-rs-db."0.1.0" { inherit profileName; }).out;
      ...
      futures = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".futures."0.3.31" { inherit profileName; }).out;
      mime = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".mime."0.3.17" { inherit profileName; }).out;
      rusty_paseto = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".rusty_paseto."0.7.2" { inherit profileName; }).out;
      sentry_tower = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".sentry-tower."0.36.0" { inherit profileName; }).out;
      tokio = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".tokio."1.44.1" { inherit profileName; }).out;
      tokio_util = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".tokio-util."0.7.14" { inherit profileName; }).out;
      tower_http = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".tower-http."0.6.2" { inherit profileName; }).out;
      tracing = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".tracing."0.1.41" { inherit profileName; }).out;
  ...
  "registry+https://github.com/rust-lang/crates.io-index".crc64fast-nvme."1.2.0" = overridableMkRustCrate (profileName: rec {
    name = "crc64fast-nvme";
    version = "1.2.0";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "4955638f00a809894c947f85a024020a20815b65a5eea633798ea7924edab2b3"; };
    dependencies = {
  ...
  "registry+https://github.com/rust-lang/crates.io-index".deranged."0.4.1" = overridableMkRustCrate (profileName: rec {
    name = "deranged";
    version = "0.4.1";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "28cfac68e08048ae1883171632c2aef3ebc555621ae56fbccce1cbf22dd7f058"; };
    features = builtins.concatLists [
      [ "alloc" ]
      [ "powerfmt" ]
      [ "std" ]
  ...
  "registry+https://github.com/rust-lang/crates.io-index".env_logger."0.11.7" = overridableMkRustCrate (profileName: rec {
    name = "env_logger";
    version = "0.11.7";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "c3716d7a920fb4fac5d84e9d4bce8ceb321e9414b4409da61b07b75c1e3d0697"; };
    features = builtins.concatLists [
      [ "auto-color" ]
      [ "color" ]
      [ "default" ]
    ...
    dependencies = {
      ...
      jiff = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".jiff."0.2.5" { inherit profileName; }).out;
      log = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".log."0.4.27" { inherit profileName; }).out;
    };
  });
  ...
  "registry+https://github.com/rust-lang/crates.io-index".event-listener."5.4.0" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      ...
      parking = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".parking."2.2.1" { inherit profileName; }).out;
      pin_project_lite = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".pin-project-lite."0.2.16" { inherit profileName; }).out;
      portable_atomic_crate = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".portable-atomic."1.11.0" { inherit profileName; }).out;
  ...
  "registry+https://github.com/rust-lang/crates.io-index".findshlibs."0.10.2" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      ${ if hostPlatform.parsed.kernel.name == "darwin" || hostPlatform.parsed.kernel.name == "ios" then "lazy_static" else null } = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".lazy_static."1.5.0" { inherit profileName; }).out;
      libc = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".libc."0.2.171" { inherit profileName; }).out;
  ...
  "registry+https://github.com/rust-lang/crates.io-index".gloo."0.8.1" = overridableMkRustCrate (profileName: rec {
    name = "gloo";
    version = "0.8.1";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "28999cda5ef6916ffd33fb4a7b87e1de633c47c0dc6d97905fee1cdaa142b94d"; };
    features = builtins.concatLists [
      [ "console" ]
      [ "default" ]
      [ "dialogs" ]
    ...
    dependencies = {
      ...
      gloo_history = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".gloo-history."0.1.5" { inherit profileName; }).out;
      gloo_net = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".gloo-net."0.3.1" { inherit profileName; }).out;
      ...
      gloo_utils = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".gloo-utils."0.1.7" { inherit profileName; }).out;
      gloo_worker = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".gloo-worker."0.2.1" { inherit profileName; }).out;
    };
  });
  
  "registry+https://github.com/rust-lang/crates.io-index".gloo."0.10.0" = overridableMkRustCrate (profileName: rec {
    name = "gloo";
    version = "0.10.0";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "cd35526c28cc55c1db77aed6296de58677dbab863b118483a27845631d870249"; };
    features = builtins.concatLists [
      [ "console" ]
      [ "default" ]
      [ "dialogs" ]
    ...
    dependencies = {
      ...
      gloo_net = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".gloo-net."0.4.0" { inherit profileName; }).out;
      ...
      gloo_worker = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".gloo-worker."0.4.0" { inherit profileName; }).out;
    };
  });
  ...
  "registry+https://github.com/rust-lang/crates.io-index".gloo-history."0.1.5" = overridableMkRustCrate (profileName: rec {
    name = "gloo-history";
    version = "0.1.5";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "85725d90bf0ed47063b3930ef28e863658a7905989e9929a8708aab74a1d5e7f"; };
    features = builtins.concatLists [
      [ "default" ]
      [ "query" ]
      [ "serde_urlencoded" ]
    ...
    dependencies = {
      ...
      gloo_utils = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".gloo-utils."0.1.7" { inherit profileName; }).out;
      serde = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".serde."1.0.219" { inherit profileName; }).out;
      serde_wasm_bindgen = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".serde-wasm-bindgen."0.5.0" { inherit profileName; }).out;
      serde_urlencoded = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".serde_urlencoded."0.7.1" { inherit profileName; }).out;
  ...
  "registry+https://github.com/rust-lang/crates.io-index".gloo-net."0.3.1" = overridableMkRustCrate (profileName: rec {
    name = "gloo-net";
    version = "0.3.1";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "a66b4e3c7d9ed8d315fd6b97c8b1f74a7c6ecbbc2320e65ae7ed38b7068cc620"; };
    features = builtins.concatLists [
      [ "default" ]
      [ "eventsource" ]
      [ "futures-channel" ]
  ...
  "registry+https://github.com/rust-lang/crates.io-index".gloo-net."0.4.0" = overridableMkRustCrate (profileName: rec {
    name = "gloo-net";
    version = "0.4.0";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "8ac9e8288ae2c632fa9f8657ac70bfe38a1530f345282d7ba66a1f70b72b7dc4"; };
    features = builtins.concatLists [
      [ "default" ]
      [ "eventsource" ]
      [ "futures-channel" ]
  ...
  "registry+https://github.com/rust-lang/crates.io-index".gloo-net."0.6.0" = overridableMkRustCrate (profileName: rec {
    name = "gloo-net";
    version = "0.6.0";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "c06f627b1a58ca3d42b45d6104bf1e1a03799df472df00988b6ba21accc10580"; };
    features = builtins.concatLists [
      [ "default" ]
      [ "eventsource" ]
      [ "futures-channel" ]
  ...
  "registry+https://github.com/rust-lang/crates.io-index".gloo-utils."0.1.7" = overridableMkRustCrate (profileName: rec {
    name = "gloo-utils";
    version = "0.1.7";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "037fcb07216cb3a30f7292bd0176b050b7b9a052ba830ef7d5d65f6dc64ba58e"; };
    features = builtins.concatLists [
      [ "default" ]
      [ "serde" ]
    ];
  ...
  "registry+https://github.com/rust-lang/crates.io-index".gloo-worker."0.4.0" = overridableMkRustCrate (profileName: rec {
    name = "gloo-worker";
    version = "0.4.0";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "76495d3dd87de51da268fa3a593da118ab43eb7f8809e17eb38d3319b424e400"; };
    features = builtins.concatLists [
      [ "default" ]
      [ "futures" ]
    ];
  ...
  "registry+https://github.com/rust-lang/crates.io-index".implicit-clone."0.4.9" = overridableMkRustCrate (profileName: rec {
    name = "implicit-clone";
    version = "0.4.9";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "f8a9aa791c7b5a71b636b7a68207fdebf171ddfc593d9c8506ec4cbc527b6a84"; };
    features = builtins.concatLists [
      [ "default" ]
      [ "derive" ]
    ...
    dependencies = {
      implicit_clone_derive = (buildRustPackages."registry+https://github.com/rust-lang/crates.io-index".implicit-clone-derive."0.1.2" { profileName = "__noProfile"; }).out;
      indexmap = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".indexmap."2.8.0" { inherit profileName; }).out;
    };
  });
  
  "registry+https://github.com/rust-lang/crates.io-index".implicit-clone-derive."0.1.2" = overridableMkRustCrate (profileName: rec {
    name = "implicit-clone-derive";
    version = "0.1.2";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "699c1b6d335e63d0ba5c1e1c7f647371ce989c3bcbe1f7ed2b85fa56e3bd1a21"; };
    dependencies = {
      quote = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".quote."1.0.40" { inherit profileName; }).out;
      syn = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".syn."2.0.100" { inherit profileName; }).out;
    };
  ...
  "registry+https://github.com/rust-lang/crates.io-index".iso8601."0.6.2" = overridableMkRustCrate (profileName: rec {
    name = "iso8601";
    version = "0.6.2";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "c5c177cff824ab21a6f41079a4c401241c4e8be14f316c4c6b07d5fca351c98d"; };
    features = builtins.concatLists [
      [ "default" ]
      [ "std" ]
    ];
  ...
  "registry+https://github.com/rust-lang/crates.io-index".jiff."0.2.5" = overridableMkRustCrate (profileName: rec {
    name = "jiff";
    version = "0.2.5";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "c102670231191d07d37a35af3eb77f1f0dbf7a71be51a962dcd57ea607be7260"; };
    features = builtins.concatLists [
      [ "alloc" ]
      [ "std" ]
    ];
    dependencies = {
      ${ if false then "jiff_static" else null } = (buildRustPackages."registry+https://github.com/rust-lang/crates.io-index".jiff-static."0.2.5" { profileName = "__noProfile"; }).out;
      log = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".log."0.4.27" { inherit profileName; }).out;
  ...
  "registry+https://github.com/rust-lang/crates.io-index".jiff-static."0.2.5" = overridableMkRustCrate (profileName: rec {
    name = "jiff-static";
    version = "0.2.5";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "4cdde31a9d349f1b1f51a0b3714a5940ac022976f4b49485fc04be052b183b4c"; };
    features = builtins.concatLists [
      [ "default" ]
    ];
    dependencies = {
  ...
  "registry+https://github.com/rust-lang/crates.io-index".metrics."0.24.1" = overridableMkRustCrate (profileName: rec {
    name = "metrics";
    version = "0.24.1";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "7a7deb012b3b2767169ff203fadb4c6b0b82b947512e5eb9e0b78c2e186ad9e3"; };
    dependencies = {
      ahash = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".ahash."0.8.11" { inherit profileName; }).out;
      ${ if hostPlatform.parsed.cpu.bits == 32 then "portable_atomic" else null } = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".portable-atomic."1.11.0" { inherit profileName; }).out;
    };
  });
  
  "registry+https://github.com/rust-lang/crates.io-index".metrics-exporter-prometheus."0.16.2" = overridableMkRustCrate (profileName: rec {
    name = "metrics-exporter-prometheus";
    version = "0.16.2";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "dd7399781913e5393588a8d8c6a2867bf85fb38eaf2502fdce465aad2dc6f034"; };
    dependencies = {
      base64 = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".base64."0.22.1" { inherit profileName; }).out;
      indexmap = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".indexmap."2.8.0" { inherit profileName; }).out;
      metrics = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".metrics."0.24.1" { inherit profileName; }).out;
      metrics_util = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".metrics-util."0.19.0" { inherit profileName; }).out;
      quanta = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".quanta."0.12.5" { inherit profileName; }).out;
      thiserror = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".thiserror."1.0.69" { inherit profileName; }).out;
    };
  });
  
  "registry+https://github.com/rust-lang/crates.io-index".metrics-util."0.19.0" = overridableMkRustCrate (profileName: rec {
    name = "metrics-util";
    version = "0.19.0";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "dbd4884b1dd24f7d6628274a2f5ae22465c337c5ba065ec9b6edccddf8acc673"; };
    features = builtins.concatLists [
      [ "crossbeam-epoch" ]
      [ "crossbeam-utils" ]
      [ "hashbrown" ]
  ...
  "registry+https://github.com/rust-lang/crates.io-index".num_threads."0.1.7" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      ${ if hostPlatform.parsed.kernel.name == "darwin" || hostPlatform.parsed.kernel.name == "ios" || hostPlatform.parsed.kernel.name == "freebsd" then "libc" else null } = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".libc."0.2.171" { inherit profileName; }).out;
    };
  });
  ...
  "registry+https://github.com/rust-lang/crates.io-index".prokio."0.1.0" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      futures = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".futures."0.3.31" { inherit profileName; }).out;
      ${ if hostPlatform.parsed.cpu.name == "wasm32" then "gloo" else null } = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".gloo."0.8.1" { inherit profileName; }).out;
      ...
      ${ if !(hostPlatform.parsed.cpu.name == "wasm32") then "once_cell" else null } = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".once_cell."1.21.1" { inherit profileName; }).out;
      pin_project = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".pin-project."1.1.10" { inherit profileName; }).out;
      pinned = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".pinned."0.1.0" { inherit profileName; }).out;
      ${ if !(hostPlatform.parsed.cpu.name == "wasm32") then "tokio" else null } = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".tokio."1.44.1" { inherit profileName; }).out;
  ...
  "registry+https://github.com/rust-lang/crates.io-index".quanta."0.12.5" = overridableMkRustCrate (profileName: rec {
    name = "quanta";
    version = "0.12.5";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "3bd1fe6824cea6538803de3ff1bc0cf3949024db3d43c9643024bfb33a807c0e"; };
    dependencies = {
      crossbeam_utils = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".crossbeam-utils."0.8.21" { inherit profileName; }).out;
      ${ if !(hostPlatform.parsed.kernel.name == "windows" || hostPlatform.parsed.cpu.name == "wasm32") then "libc" else null } = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".libc."0.2.171" { inherit profileName; }).out;
      once_cell = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".once_cell."1.21.1" { inherit profileName; }).out;
  ...
  "registry+https://github.com/rust-lang/crates.io-index".reqwest."0.12.15" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      ...
      ${ if !(hostPlatform.parsed.cpu.name == "wasm32") then "rustls" else null } = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".rustls."0.23.25" { inherit profileName; }).out;
  ...
  "registry+https://github.com/rust-lang/crates.io-index".rustls."0.23.25" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      aws_lc_rs = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".aws-lc-rs."1.12.6" { inherit profileName; }).out;
      log = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".log."0.4.27" { inherit profileName; }).out;
      once_cell = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".once_cell."1.21.1" { inherit profileName; }).out;
      ring = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".ring."0.17.14" { inherit profileName; }).out;
      pki_types = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".rustls-pki-types."1.11.0" { inherit profileName; }).out;
  ...
  "registry+https://github.com/rust-lang/crates.io-index".rusty_paseto."0.7.2" = overridableMkRustCrate (profileName: rec {
    name = "rusty_paseto";
    version = "0.7.2";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "05501841a4cac5c065cb6a501a62207c4c235e37d2882579a2505a2aa2837826"; };
    features = builtins.concatLists [
      [ "batteries_included" ]
      [ "blake2" ]
      [ "chacha20" ]
    ...
    dependencies = {
      ...
      hex = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".hex."0.4.3" { inherit profileName; }).out;
      iso8601 = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".iso8601."0.6.2" { inherit profileName; }).out;
      rand_core = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".rand_core."0.6.4" { inherit profileName; }).out;
      ring = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".ring."0.17.14" { inherit profileName; }).out;
      serde = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".serde."1.0.219" { inherit profileName; }).out;
      serde_json = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".serde_json."1.0.140" { inherit profileName; }).out;
  ...
  "registry+https://github.com/rust-lang/crates.io-index".sentry."0.36.0" = overridableMkRustCrate (profileName: rec {
    name = "sentry";
    version = "0.36.0";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "3a7332159e544e34db06b251b1eda5e546bd90285c3f58d9c8ff8450b484e0da"; };
    features = builtins.concatLists [
      [ "backtrace" ]
      [ "contexts" ]
      [ "debug-images" ]
    ...
    dependencies = {
      ...
      reqwest = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".reqwest."0.12.15" { inherit profileName; }).out;
      rustls = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".rustls."0.23.25" { inherit profileName; }).out;
      sentry_backtrace = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".sentry-backtrace."0.36.0" { inherit profileName; }).out;
      sentry_contexts = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".sentry-contexts."0.36.0" { inherit profileName; }).out;
      sentry_core = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".sentry-core."0.36.0" { inherit profileName; }).out;
      sentry_debug_images = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".sentry-debug-images."0.36.0" { inherit profileName; }).out;
      sentry_panic = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".sentry-panic."0.36.0" { inherit profileName; }).out;
      sentry_tracing = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".sentry-tracing."0.36.0" { inherit profileName; }).out;
      tokio = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".tokio."1.44.1" { inherit profileName; }).out;
  ...
  "registry+https://github.com/rust-lang/crates.io-index".sentry-backtrace."0.36.0" = overridableMkRustCrate (profileName: rec {
    name = "sentry-backtrace";
    version = "0.36.0";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "565ec31ad37bab8e6d9f289f34913ed8768347b133706192f10606dabd5c6bc4"; };
    dependencies = {
      backtrace = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".backtrace."0.3.71" { inherit profileName; }).out;
      once_cell = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".once_cell."1.21.1" { inherit profileName; }).out;
      regex = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".regex."1.11.1" { inherit profileName; }).out;
  ...
  "registry+https://github.com/rust-lang/crates.io-index".sentry-contexts."0.36.0" = overridableMkRustCrate (profileName: rec {
    name = "sentry-contexts";
    version = "0.36.0";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "e860275f25f27e8c0c7726ce116c7d5c928c5bba2ee73306e52b20a752298ea6"; };
    dependencies = {
      hostname = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".hostname."0.4.0" { inherit profileName; }).out;
      libc = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".libc."0.2.171" { inherit profileName; }).out;
      ${ if hostPlatform.isWindows then "os_info" else null } = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".os_info."3.10.0" { inherit profileName; }).out;
      sentry_core = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".sentry-core."0.36.0" { inherit profileName; }).out;
  ...
  "registry+https://github.com/rust-lang/crates.io-index".sentry-core."0.36.0" = overridableMkRustCrate (profileName: rec {
    name = "sentry-core";
    version = "0.36.0";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "653942e6141f16651273159f4b8b1eaeedf37a7554c00cd798953e64b8a9bf72"; };
    features = builtins.concatLists [
      [ "client" ]
      [ "crc32fast" ]
      [ "default" ]
    ...
    dependencies = {
      ...
      rand = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".rand."0.8.5" { inherit profileName; }).out;
      regex = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".regex."1.11.1" { inherit profileName; }).out;
      sentry_types = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".sentry-types."0.36.0" { inherit profileName; }).out;
      serde = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".serde."1.0.219" { inherit profileName; }).out;
      serde_json = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".serde_json."1.0.140" { inherit profileName; }).out;
    };
  });
  
  "registry+https://github.com/rust-lang/crates.io-index".sentry-debug-images."0.36.0" = overridableMkRustCrate (profileName: rec {
    name = "sentry-debug-images";
    version = "0.36.0";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "2a60bc2154e6df59beed0ac13d58f8dfaf5ad20a88548a53e29e4d92e8e835c2"; };
    dependencies = {
  ...
  "git+https://github.com/auguwu/sentry-eyre".sentry-eyre."0.2.0" = overridableMkRustCrate (profileName: rec {
    name = "sentry-eyre";
    version = "0.2.0";
    ...
    src = fetchCrateGit {
      ...
      name = "sentry-eyre";
      version = "0.2.0";
      rev = "41b1324b19668070abba5dd99f47cffdfcc4849f";};
    dependencies = {
      eyre = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".eyre."0.6.12" { inherit profileName; }).out;
      sentry_core = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".sentry-core."0.36.0" { inherit profileName; }).out;
    };
  ...
  "registry+https://github.com/rust-lang/crates.io-index".sentry-panic."0.36.0" = overridableMkRustCrate (profileName: rec {
    name = "sentry-panic";
    version = "0.36.0";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "105e3a956c8aa9dab1e4087b1657b03271bfc49d838c6ae9bfc7c58c802fd0ef"; };
    dependencies = {
      sentry_backtrace = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".sentry-backtrace."0.36.0" { inherit profileName; }).out;
      sentry_core = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".sentry-core."0.36.0" { inherit profileName; }).out;
    };
  ...
  "registry+https://github.com/rust-lang/crates.io-index".sentry-tower."0.36.0" = overridableMkRustCrate (profileName: rec {
    name = "sentry-tower";
    version = "0.36.0";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "082f781dfc504d984e16d99f8dbf94d6ee4762dd0fc28de25713d0f900a8164d"; };
    features = builtins.concatLists [
      [ "axum" ]
      [ "axum-matched-path" ]
      [ "http" ]
  ...
  "registry+https://github.com/rust-lang/crates.io-index".sentry-tracing."0.36.0" = overridableMkRustCrate (profileName: rec {
    name = "sentry-tracing";
    version = "0.36.0";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "64e75c831b4d8b34a5aec1f65f67c5d46a26c7c5d3c7abd8b5ef430796900cf8"; };
    features = builtins.concatLists [
      [ "backtrace" ]
      [ "default" ]
    ];
  ...
  "registry+https://github.com/rust-lang/crates.io-index".sentry-types."0.36.0" = overridableMkRustCrate (profileName: rec {
    name = "sentry-types";
    version = "0.36.0";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "2d4203359e60724aa05cf2385aaf5d4f147e837185d7dd2b9ccf1ee77f4420c8"; };
    features = builtins.concatLists [
      [ "default" ]
      [ "metrics" ]
      [ "protocol" ]
  ...
  "registry+https://github.com/rust-lang/crates.io-index".serde-wasm-bindgen."0.5.0" = overridableMkRustCrate (profileName: rec {
    name = "serde-wasm-bindgen";
    version = "0.5.0";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "f3b143e2833c57ab9ad3ea280d21fd34e285a42837aeb0ee301f4f41890fa00e"; };
    dependencies = {
      js_sys = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".js-sys."0.3.77" { inherit profileName; }).out;
      serde = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".serde."1.0.219" { inherit profileName; }).out;
      wasm_bindgen = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".wasm-bindgen."0.2.100" { inherit profileName; }).out;
  ...
  "registry+https://github.com/rust-lang/crates.io-index".sqlx."0.8.3" = overridableMkRustCrate (profileName: rec {
    name = "sqlx";
    version = "0.8.3";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "4410e73b3c0d8442c5f99b425d7a435b5ee0ae4167b3196771dd3f7a01be745f"; };
    features = builtins.concatLists [
      [ "_rt-tokio" ]
      [ "_sqlite" ]
      [ "derive" ]
    ...
    dependencies = {
      sqlx_core = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".sqlx-core."0.8.3" { inherit profileName; }).out;
      sqlx_macros = (buildRustPackages."registry+https://github.com/rust-lang/crates.io-index".sqlx-macros."0.8.3" { profileName = "__noProfile"; }).out;
      sqlx_mysql = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".sqlx-mysql."0.8.3" { inherit profileName; }).out;
      sqlx_postgres = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".sqlx-postgres."0.8.3" { inherit profileName; }).out;
      sqlx_sqlite = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".sqlx-sqlite."0.8.3" { inherit profileName; }).out;
    };
  });
  
  "registry+https://github.com/rust-lang/crates.io-index".sqlx-core."0.8.3" = overridableMkRustCrate (profileName: rec {
    name = "sqlx-core";
    version = "0.8.3";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "6a007b6936676aa9ab40207cde35daab0a04b823be8ae004368c0793b96a61e0"; };
    features = builtins.concatLists [
      [ "_rt-tokio" ]
      [ "any" ]
      [ "crc" ]
  ...
  "registry+https://github.com/rust-lang/crates.io-index".sqlx-macros."0.8.3" = overridableMkRustCrate (profileName: rec {
    name = "sqlx-macros";
    version = "0.8.3";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "3112e2ad78643fef903618d78cf0aec1cb3134b019730edb039b69eaf531f310"; };
    features = builtins.concatLists [
      [ "_rt-tokio" ]
      [ "default" ]
      [ "derive" ]
    ...
    dependencies = {
      ...
      quote = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".quote."1.0.40" { inherit profileName; }).out;
      sqlx_core = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".sqlx-core."0.8.3" { inherit profileName; }).out;
      sqlx_macros_core = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".sqlx-macros-core."0.8.3" { inherit profileName; }).out;
      syn = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".syn."2.0.100" { inherit profileName; }).out;
    };
  });
  
  "registry+https://github.com/rust-lang/crates.io-index".sqlx-macros-core."0.8.3" = overridableMkRustCrate (profileName: rec {
    name = "sqlx-macros-core";
    version = "0.8.3";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "4e9f90acc5ab146a99bf5061a7eb4976b573f560bc898ef3bf8435448dd5e7ad"; };
    features = builtins.concatLists [
      [ "_rt-tokio" ]
      [ "_sqlite" ]
      [ "default" ]
  ...
  "registry+https://github.com/rust-lang/crates.io-index".sqlx-mysql."0.8.3" = overridableMkRustCrate (profileName: rec {
    name = "sqlx-mysql";
    version = "0.8.3";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "4560278f0e00ce64938540546f59f590d60beee33fffbd3b9cd47851e5fff233"; };
    features = builtins.concatLists [
      [ "migrate" ]
    ];
    dependencies = {
  ...
  "registry+https://github.com/rust-lang/crates.io-index".sqlx-postgres."0.8.3" = overridableMkRustCrate (profileName: rec {
    name = "sqlx-postgres";
    version = "0.8.3";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "c5b98a57f363ed6764d5b3a12bfedf62f07aa16e1856a7ddc2a0bb190a959613"; };
    features = builtins.concatLists [
      [ "migrate" ]
      [ "offline" ]
    ];
  ...
  "registry+https://github.com/rust-lang/crates.io-index".sqlx-sqlite."0.8.3" = overridableMkRustCrate (profileName: rec {
    name = "sqlx-sqlite";
    version = "0.8.3";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "f85ca71d3a5b24e64e1d08dd8fe36c6c95c339a896cc33068148906784620540"; };
    features = builtins.concatLists [
      [ "bundled" ]
      [ "migrate" ]
      [ "offline" ]
  ...
  "registry+https://github.com/rust-lang/crates.io-index".stretto."0.8.4" = overridableMkRustCrate (profileName: rec {
    name = "stretto";
    version = "0.8.4";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "70a313e115c2cd9a88d99d60386bc88641c853d468b2c3bc454c294f385fc084"; };
    features = builtins.concatLists [
      [ "async" ]
      [ "async-channel" ]
      [ "async-io" ]
    ...
    dependencies = {
      ...
      atomic = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".atomic."0.6.0" { inherit profileName; }).out;
      ...
      thiserror = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".thiserror."1.0.69" { inherit profileName; }).out;
      tracing = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".tracing."0.1.41" { inherit profileName; }).out;
      wg = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".wg."0.9.2" { inherit profileName; }).out;
  ...
  "registry+https://github.com/rust-lang/crates.io-index".time."0.3.41" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      deranged = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".deranged."0.4.1" { inherit profileName; }).out;
      itoa = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".itoa."1.0.15" { inherit profileName; }).out;
      ${ if hostPlatform.isUnix then "libc" else null } = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".libc."0.2.171" { inherit profileName; }).out;
  ...
  "registry+https://github.com/rust-lang/crates.io-index".unty."0.0.4" = overridableMkRustCrate (profileName: rec {
    name = "unty";
    version = "0.0.4";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "6d49784317cd0d1ee7ec5c716dd598ec5b4483ea832a2dced265471cc0f690ae"; };
  });
  ...
  "registry+https://github.com/rust-lang/crates.io-index".ureq."2.12.1" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      base64 = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".base64."0.22.1" { inherit profileName; }).out;
      brotli_decompressor = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".brotli-decompressor."4.0.2" { inherit profileName; }).out;
  ...
  "registry+https://github.com/rust-lang/crates.io-index".virtue."0.0.18" = overridableMkRustCrate (profileName: rec {
    name = "virtue";
    version = "0.0.18";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "051eb1abcf10076295e815102942cc58f9d5e3b4560e46e53c21e8ff6f3af7b1"; };
  });
  ...
  "registry+https://github.com/rust-lang/crates.io-index".walrus."0.23.3" = overridableMkRustCrate (profileName: rec {
    name = "walrus";
    version = "0.23.3";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "6481311b98508f4bc2d0abbfa5d42172e7a54b4b24d8f15e28b0dc650be0c59f"; };
    features = builtins.concatLists [
      [ "parallel" ]
      [ "rayon" ]
    ];
    dependencies = {
      ...
      log = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".log."0.4.27" { inherit profileName; }).out;
      rayon = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".rayon."1.10.0" { inherit profileName; }).out;
      walrus_macro = (buildRustPackages."registry+https://github.com/rust-lang/crates.io-index".walrus-macro."0.22.0" { profileName = "__noProfile"; }).out;
      wasm_encoder = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".wasm-encoder."0.214.0" { inherit profileName; }).out;
      wasmparser = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".wasmparser."0.214.0" { inherit profileName; }).out;
    };
  });
  
  "registry+https://github.com/rust-lang/crates.io-index".walrus-macro."0.22.0" = overridableMkRustCrate (profileName: rec {
    name = "walrus-macro";
    version = "0.22.0";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "439ad39ff894c43c9649fa724cdde9a6fc50b855d517ef071a93e5df82fe51d3"; };
    dependencies = {
      heck = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".heck."0.5.0" { inherit profileName; }).out;
      proc_macro2 = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".proc-macro2."1.0.94" { inherit profileName; }).out;
      quote = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".quote."1.0.40" { inherit profileName; }).out;
  ...
  "registry+https://github.com/rust-lang/crates.io-index".wasm-bindgen-cli."0.2.100" = overridableMkRustCrate (profileName: rec {
    name = "wasm-bindgen-cli";
    version = "0.2.100";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "9e7f06f41580c87b6f4f84176d033f09c0838db1523a8d1899064b53cbb92c59"; };
    features = builtins.concatLists [
      [ "default" ]
      [ "rustls-tls" ]
    ];
    dependencies = {
      anyhow = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".anyhow."1.0.97" { inherit profileName; }).out;
      clap = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".clap."4.5.34" { inherit profileName; }).out;
      env_logger = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".env_logger."0.11.7" { inherit profileName; }).out;
      log = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".log."0.4.27" { inherit profileName; }).out;
      ...
      tempfile = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".tempfile."3.19.1" { inherit profileName; }).out;
      ureq = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".ureq."2.12.1" { inherit profileName; }).out;
      walrus = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".walrus."0.23.3" { inherit profileName; }).out;
      wasm_bindgen_cli_support = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".wasm-bindgen-cli-support."0.2.100" { inherit profileName; }).out;
      wasm_bindgen_shared = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".wasm-bindgen-shared."0.2.100" { inherit profileName; }).out;
    };
  });
  
  "registry+https://github.com/rust-lang/crates.io-index".wasm-bindgen-cli-support."0.2.100" = overridableMkRustCrate (profileName: rec {
    name = "wasm-bindgen-cli-support";
    version = "0.2.100";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "21e1a4a49abe9cd6f762fc65fac2ef5732afeeb66be369d2f71a85b165a533cf"; };
    dependencies = {
      anyhow = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".anyhow."1.0.97" { inherit profileName; }).out;
      base64 = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".base64."0.22.1" { inherit profileName; }).out;
      log = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".log."0.4.27" { inherit profileName; }).out;
      ...
      tempfile = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".tempfile."3.19.1" { inherit profileName; }).out;
      walrus = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".walrus."0.23.3" { inherit profileName; }).out;
      wasm_bindgen_externref_xform = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".wasm-bindgen-externref-xform."0.2.100" { inherit profileName; }).out;
      wasm_bindgen_multi_value_xform = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".wasm-bindgen-multi-value-xform."0.2.100" { inherit profileName; }).out;
      wasm_bindgen_shared = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".wasm-bindgen-shared."0.2.100" { inherit profileName; }).out;
      wasm_bindgen_threads_xform = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".wasm-bindgen-threads-xform."0.2.100" { inherit profileName; }).out;
      wasm_bindgen_wasm_conventions = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".wasm-bindgen-wasm-conventions."0.2.100" { inherit profileName; }).out;
      wasm_bindgen_wasm_interpreter = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".wasm-bindgen-wasm-interpreter."0.2.100" { inherit profileName; }).out;
    };
  });
  
  "registry+https://github.com/rust-lang/crates.io-index".wasm-bindgen-externref-xform."0.2.100" = overridableMkRustCrate (profileName: rec {
    name = "wasm-bindgen-externref-xform";
    version = "0.2.100";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "940542c5cdbe96c35f98b5da5c65fb9d18df55a0cb1d81fc5ca4acc4fda4d61c"; };
    dependencies = {
      anyhow = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".anyhow."1.0.97" { inherit profileName; }).out;
      walrus = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".walrus."0.23.3" { inherit profileName; }).out;
      wasm_bindgen_wasm_conventions = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".wasm-bindgen-wasm-conventions."0.2.100" { inherit profileName; }).out;
  ...
  "registry+https://github.com/rust-lang/crates.io-index".wasm-bindgen-multi-value-xform."0.2.100" = overridableMkRustCrate (profileName: rec {
    name = "wasm-bindgen-multi-value-xform";
    version = "0.2.100";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "64b5ad2e97adde0c3e4369c38e0dbaee329ad8f6cc2ee8e01d1d0b13bd8b14cf"; };
    dependencies = {
      anyhow = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".anyhow."1.0.97" { inherit profileName; }).out;
      walrus = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".walrus."0.23.3" { inherit profileName; }).out;
      wasm_bindgen_wasm_conventions = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".wasm-bindgen-wasm-conventions."0.2.100" { inherit profileName; }).out;
  ...
  "registry+https://github.com/rust-lang/crates.io-index".wasm-bindgen-threads-xform."0.2.100" = overridableMkRustCrate (profileName: rec {
    name = "wasm-bindgen-threads-xform";
    version = "0.2.100";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "1cbdf2d55a50f7edc9dd9aecae7a3a40e9736fda851bd8816f98a86167c8c277"; };
    dependencies = {
      anyhow = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".anyhow."1.0.97" { inherit profileName; }).out;
      walrus = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".walrus."0.23.3" { inherit profileName; }).out;
      wasm_bindgen_wasm_conventions = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".wasm-bindgen-wasm-conventions."0.2.100" { inherit profileName; }).out;
  ...
  "registry+https://github.com/rust-lang/crates.io-index".wasm-bindgen-wasm-conventions."0.2.100" = overridableMkRustCrate (profileName: rec {
    name = "wasm-bindgen-wasm-conventions";
    version = "0.2.100";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "b1c24fcaa34d2d84407122cfb1d3f37c3586756cf462be18e049b49245a16c08"; };
    dependencies = {
      anyhow = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".anyhow."1.0.97" { inherit profileName; }).out;
      leb128 = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".leb128."0.2.5" { inherit profileName; }).out;
      log = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".log."0.4.27" { inherit profileName; }).out;
  ...
  "registry+https://github.com/rust-lang/crates.io-index".wasm-bindgen-wasm-interpreter."0.2.100" = overridableMkRustCrate (profileName: rec {
    name = "wasm-bindgen-wasm-interpreter";
    version = "0.2.100";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "33f24921401faadd6944206f9d6837d07bbb5ff766ed51ad34528089f66550e0"; };
    dependencies = {
      anyhow = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".anyhow."1.0.97" { inherit profileName; }).out;
      log = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".log."0.4.27" { inherit profileName; }).out;
      walrus = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".walrus."0.23.3" { inherit profileName; }).out;
  ...
  "registry+https://github.com/rust-lang/crates.io-index".wasm-encoder."0.214.0" = overridableMkRustCrate (profileName: rec {
    name = "wasm-encoder";
    version = "0.214.0";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "ff694f02a8d7a50b6922b197ae03883fbf18cdb2ae9fbee7b6148456f5f44041"; };
    dependencies = {
      leb128 = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".leb128."0.2.5" { inherit profileName; }).out;
    };
  });
  ...
  "registry+https://github.com/rust-lang/crates.io-index".wasm-tracing."2.0.0" = overridableMkRustCrate (profileName: rec {
    name = "wasm-tracing";
    version = "2.0.0";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "eb675aa3376d079f9c5710cf2c96126e97eebe6565a092bcfbcb041d7c67509c"; };
    dependencies = {
      tracing = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".tracing."0.1.41" { inherit profileName; }).out;
      tracing_subscriber = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".tracing-subscriber."0.3.19" { inherit profileName; }).out;
      wasm_bindgen = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".wasm-bindgen."0.2.100" { inherit profileName; }).out;
  ...
  "registry+https://github.com/rust-lang/crates.io-index".wasmparser."0.214.0" = overridableMkRustCrate (profileName: rec {
    name = "wasmparser";
    version = "0.214.0";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "5309c1090e3e84dad0d382f42064e9933fdaedb87e468cc239f0eabea73ddcb6"; };
    features = builtins.concatLists [
      [ "default" ]
      [ "serde" ]
      [ "std" ]
  ...
  "registry+https://github.com/rust-lang/crates.io-index".wg."0.9.2" = overridableMkRustCrate (profileName: rec {
    name = "wg";
    version = "0.9.2";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "7aafc5e81e847f05d6770e074faf7b1cd4a5dec9a0e88eac5d55e20fdfebee9a"; };
    features = builtins.concatLists [
      [ "default" ]
      [ "event-listener" ]
      [ "future" ]
  ...
  "registry+https://github.com/rust-lang/crates.io-index".whoami."1.6.0" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      ${ if hostPlatform.parsed.kernel.name == "redox" && !(hostPlatform.parsed.cpu.name == "wasm32") then "syscall" else null } = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".redox_syscall."0.5.10" { inherit profileName; }).out;
  ...
  "registry+https://github.com/rust-lang/crates.io-index".yew."0.21.0" = overridableMkRustCrate (profileName: rec {
    name = "yew";
    version = "0.21.0";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "5f1a03f255c70c7aa3e9c62e15292f142ede0564123543c1cc0c7a4f31660cac"; };
    features = builtins.concatLists [
      [ "csr" ]
      [ "default" ]
    ];
    dependencies = {
      console_error_panic_hook = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".console_error_panic_hook."0.1.7" { inherit profileName; }).out;
      futures = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".futures."0.3.31" { inherit profileName; }).out;
      gloo = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".gloo."0.10.0" { inherit profileName; }).out;
      implicit_clone = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".implicit-clone."0.4.9" { inherit profileName; }).out;
      indexmap = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".indexmap."2.8.0" { inherit profileName; }).out;
      js_sys = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".js-sys."0.3.77" { inherit profileName; }).out;
      ...
      ${ if hostPlatform.parsed.cpu.name == "wasm32" then "wasm_bindgen_futures" else null } = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".wasm-bindgen-futures."0.4.50" { inherit profileName; }).out;
      web_sys = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".web-sys."0.3.77" { inherit profileName; }).out;
      yew_macro = (buildRustPackages."registry+https://github.com/rust-lang/crates.io-index".yew-macro."0.21.0" { profileName = "__noProfile"; }).out;
    };
  });
  
  "registry+https://github.com/rust-lang/crates.io-index".yew-macro."0.21.0" = overridableMkRustCrate (profileName: rec {
    name = "yew-macro";
    version = "0.21.0";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "02fd8ca5166d69e59f796500a2ce432ff751edecbbb308ca59fd3fe4d0343de2"; };
    dependencies = {
  ...
  "registry+https://github.com/rust-lang/crates.io-index".yew-router."0.18.0" = overridableMkRustCrate (profileName: rec {
    name = "yew-router";
    version = "0.18.0";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "4ca1d5052c96e6762b4d6209a8aded597758d442e6c479995faf0c7b5538e0c6"; };
    dependencies = {
      gloo = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".gloo."0.10.0" { inherit profileName; }).out;
      js_sys = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".js-sys."0.3.77" { inherit profileName; }).out;
      ...
      web_sys = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".web-sys."0.3.77" { inherit profileName; }).out;
      yew = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".yew."0.21.0" { inherit profileName; }).out;
      yew_router_macro = (buildRustPackages."registry+https://github.com/rust-lang/crates.io-index".yew-router-macro."0.18.0" { profileName = "__noProfile"; }).out;
    };
  });
  
  "registry+https://github.com/rust-lang/crates.io-index".yew-router-macro."0.18.0" = overridableMkRustCrate (profileName: rec {
    name = "yew-router-macro";
    version = "0.18.0";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "42bfd190a07ca8cfde7cd4c52b3ac463803dc07323db8c34daa697e86365978c"; };
    dependencies = {
      proc_macro2 = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".proc-macro2."1.0.94" { inherit profileName; }).out;
      quote = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".quote."1.0.40" { inherit profileName; }).out;
      syn = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".syn."2.0.100" { inherit profileName; }).out;
