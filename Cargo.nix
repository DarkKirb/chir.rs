...
let
  nixifiedLockHash = "a2ea4a45e714179d20e970202780a96d79fa271648e85ca0026dafa6d2b7aabd";
...
if !lockHashIgnored && (nixifiedLockHash != currentLockHash) then
  ...
  in
  {
    ...
    "registry+https://github.com/rust-lang/crates.io-index".blake3."1.6.1" =
      overridableMkRustCrate
        (profileName: rec {
          name = "blake3";
          version = "1.6.1";
    ...
    "unknown".chir-rs-castore."0.1.0" = overridableMkRustCrate (profileName: rec {
      ...
      dependencies = {
        ...
        blake3 =
          (rustPackages."registry+https://github.com/rust-lang/crates.io-index".blake3."1.6.1" {
            inherit profileName;
          }).out;
        bytes =
          (rustPackages."registry+https://github.com/rust-lang/crates.io-index".bytes."1.10.0" {
