...
args @ {
  ...
  nixifiedLockHash = "fb37cde62c12ef81d30fd7f218556e568639a9b39f1477203c878612dd5826b7";
  workspaceSrc =
...
in
  ...
  in {
    ...
    "registry+https://github.com/rust-lang/crates.io-index".arc-swap."1.7.0" = overridableMkRustCrate (profileName: rec {
      name = "arc-swap";
      version = "1.7.0";
      registry = "registry+https://github.com/rust-lang/crates.io-index";
      src = fetchCratesIo {
        inherit name version;
        sha256 = "7b3d0060af21e8d11a926981cc00c6c1541aa91dd64b9f881985c3da1094425f";
      };
    });
    ...
    "registry+https://github.com/rust-lang/crates.io-index".fluent-templates."0.9.1" = overridableMkRustCrate (profileName: rec {
      ...
      dependencies = {
        arc_swap = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".arc-swap."1.7.0" {inherit profileName;}).out;
    ...
    "registry+https://github.com/rust-lang/crates.io-index".tokio."1.36.0" = overridableMkRustCrate (profileName: rec {
      ...
      dependencies = {
        ${
          ...
          (rustPackages."registry+https://github.com/rust-lang/crates.io-index".backtrace."0.3.69" {inherit profileName;}).out;
        bytes = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".bytes."1.5.0" {inherit profileName;}).out;
        ${
          if hostPlatform.isUnix
          then "libc"
